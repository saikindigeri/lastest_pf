...
export default function ProjectsSection() {
  ...
  >
    ...
    <div className="relative overflow-hidden w-full"> {/* Ensures no vertical scroll */}
      <motion.div
   ...
   className={`w-[230px] md:w-[260px] rounded-lg overflow-hidden shadow-md transition-all duration-300 flex flex-col
     ${
       isDarkMode
 ...
 >
            ...
            <div className="p-3 border-gray-400 flex justify-between items-center">
              <a
              ...
              >
                <p className="text-base italic opacity-80">Website</p>
              </a>
            </div>
          </motion.div>
        ))}
